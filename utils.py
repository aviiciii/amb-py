...
def print_closing_balance(statement_date_to, closing_balances):
    print("\n", "--  Closing Balances  --", "\n")
    temp = 0
...
def print_amb_status(total, statement_month, statement_date_from, statement_date_to, amb_limit, days, closing_balances):
...
def get_closing_balances(file_name):
    ...
    return total, statement_month, statement_date_from, statement_date_to, days, closing_balances